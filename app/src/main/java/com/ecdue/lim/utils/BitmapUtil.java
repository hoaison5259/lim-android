...
// Credit goes to Jason Robinson's answer on this post
...
public class BitmapUtil {
    public static Bitmap handleSamplingAndRotationBitmap(Context context, Bitmap bitmap)
            throws IOException {
        int MAX_HEIGHT = 1024;
        int MAX_WIDTH = 1024;
        Uri selectedImage = getImageUriFromBitmap(context, bitmap);
